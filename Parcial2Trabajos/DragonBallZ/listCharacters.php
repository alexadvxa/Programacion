            ...
            <ul>
                <?php foreach ($characters as $character): ?>
                    <li>
                        ...
                        <form action="characterDetails.php" method="get" style="display:inline;">
                        ...
                        <form action="deleteCharacter.php" method="post" style="display:inline;">
                            <input type="hidden" name="character_id" value="<?php echo $character['id']; ?>">
                            <button type="submit" onclick="return confirm('¿Estás seguro de que deseas eliminar este personaje?');">Eliminar</button>
                        </form>
                    </li>
                <?php endforeach; ?>
            </ul>
